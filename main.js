...
function initDrawerSwipe() {
    ...
    drawer.addEventListener('touchmove',  e => { if (!dragging) return; currentX = e.touches[0].clientX; drawer.style.transform = 'translateX(' + Math.min(0, currentX - startX) + 'px)'; }, { passive:true });
